...
int main()
{
    ...
    input_opcode = fopen("input_op.txt", "r+"); //input_opcode contains a list of opcodes followed by their format and mac.code
    ...
    input_instructions = fopen("input_ins.txt", "r+");
